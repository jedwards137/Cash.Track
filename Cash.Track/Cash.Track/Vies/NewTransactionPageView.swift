...
class NewTransactionPageView: UIViewBase {
    ...
    private(set) var TransactionTypeField = TransactionTypeUnderlinedTextField(title: "Deposit / Withdrawal", highlightColor: .black, textAlignment: .left, placeholder: "Deposit", underlineColor: .lightGray)
