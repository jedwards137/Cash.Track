...
class EditTransactionPageView: UIViewBase {
    ...
    public func setTransactionInfo(with transaction: Transaction) {
        ...
        TransactionCategoryField.Field.text = transaction.Category
    ...
    public override func addSubviews() {
        let subviews = [TransactionNameField, TransactionCategoryField, TransactionTypeField, AmountField, DateTimeField, DeleteButton, UpdateButton]
    ...
    public override func anchorSubviews() {
        ...
        TransactionCategoryField.setTopAnchor(to: TransactionNameField.bottomAnchor, withPadding: 3*EdgePadding)
        ...
        TransactionTypeField.setTopAnchor(to: TransactionCategoryField.bottomAnchor, withPadding: 3*EdgePadding)
